...
export default function Index() {
  ...
  return (
    <div className="w-full">
        ...
        <div className="relative z-20 container mx-auto text-center max-w-full w-full">
          <div className="animate-fade-in-up px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-bold pb-4 mb-4 sm:mb-6 leading-tight">
              ...
              <span className="block text-red-400">Digital Growth</span>
            </h1>
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-4">
              We protect your online presence with cutting-edge cybersecurity
              solutions, while also crafting innovative web and mobile
              applications to drive your business forward.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center mb-12 sm:mb-16 px-4">
              <Link to="/contact">
                <Button
                  size="lg"
                  className="bg-primary hover:bg-primary/90 text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 group w-full sm:w-auto"
                >
                  Start Your Project
              ...
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 border-primary text-primary hover:bg-primary hover:text-primary-foreground group w-full sm:w-auto"
                >
        ...
        <div className="container mx-auto max-w-full">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4">
              ...
              accelerate your growth in the digital landscape
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Protecting your digital assets and ensuring compliance with industry standards",
                features: [
                  "VAPT",
                  "GRC",
                  "Security Awareness",
              ...
              },
              {
                ...
                features: ["Iron Manager", "B-Connect", "Linkfy", "EPoint"],
                color: "from-orange-500 to-red-500",
              ...
              <Card
                key={index}
                className="group hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 hover:-translate-y-3 bg-background border-border relative overflow-hidden"
              >
                <div
      ...
      <section
        id="about"
        className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 opacity-0 w-full"
        ref={addToRefs}
      >
        <div className="container mx-auto max-w-full">
      ...
      {/* CTA Section */}
      <section
        className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary/10 to-red-500/10 opacity-0 w-full"
        ref={addToRefs}
      >
        <div className="container mx-auto text-center max-w-full">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-8 sm:mb-12 leading-relaxed">
              ...
              design and development solutions that drive real results.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
              <Link to="/contact">
                <Button
                  size="lg"
                  className="bg-primary hover:bg-primary/90 text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 group w-full sm:w-auto"
                >
                  Start Your Journey
                  <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5 group-hover:translate-x-1 transition-transform" />
                </Button>
              ...
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 border-primary text-primary hover:bg-primary hover:text-primary-foreground w-full sm:w-auto"
                >
                  Schedule a Call
                </Button>
              </Link>
